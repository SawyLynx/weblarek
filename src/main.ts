...
console.log('Получение товара для подробного отображения', products.getItemCard());
...
console.log('Получение массива товаров корзины, после удаления товара', cart.getItems());
console.log('Получение количества товаров корзины, после удаления товара', cart.getCount());

console.log(`Проверка наличия товара в корзине по id ${item1.id}`, cart.isInTheCart(item1.id));
console.log(`Проверка наличия товара в корзине по id ${item2.id}`, cart.isInTheCart(item2.id));

cart.clearCart();
console.log('Получение массива товаров, после очистки корзины', cart.getItems())
